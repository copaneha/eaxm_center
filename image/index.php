...
<section class="hero">
    <div class="hero-content">
        <h1>Online Exam Centre <br> <span>Management System</span></h1>
...
<div class="i">
    <div class="container">
        ...
        <div class="login-container">
            <a href="#" class="login-btn student-btn">Student Login</a>
            <a href="#" class="login-btn admin-btn">Admin / Proctor Login</a>
        </div>
        ...
        <div class="row main-features-row g-0">
            ...
            <div class="col-md-4">
                <div class="feature-box">
                    <img src="image/ChatGPT Image Mar 16, 2026, 03_03_01 PM.png" class="feature-icon-lg" alt="Monitoring">
                    <h3>Real-Time Monitoring</h3>
                    <h5>Live Proctoring & Exam Surveillance</h5>
                </div>
            </div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="key-feature-card">
                    <img src="image/ChatGPT Image Mar 16, 2026, 03_03_09 PM.png">
                    <h3>Live Proctoring</h3>
                      <h4>Real-time exam supervision</h4>
                </div>
            </div>
